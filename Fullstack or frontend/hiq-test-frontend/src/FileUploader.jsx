            ...
            <div className="bg-[#FFFFFF] w-full max-w-2xl rounded-2xl shadow-xl p-8 space-y-6">
                ...
                <div className="flex flex-col items-center justify-center mt-8">
                    <Button
                        ...
                        size="xl"
                        icon={UploadCloud}
                        className="w-[250px] mt-6 mb-8 bg-[#6366F1] hover:bg-[#4F46E5] text-white rounded-full py-4 text-lg font-semibold"
                    >
                        Välj fil
                    </Button>
                    ...
                    <Button
                        ...
                        loading={loading}
                        disabled={!file}
                        className="w-[250px] bg-[#34D399] hover:bg-[#10B981] text-white disabled:bg-[#D1D5DB] rounded-full py-4 text-lg font-semibold"
                    >
                        Ladda upp & Bearbeta
                    </Button>
                </div>
